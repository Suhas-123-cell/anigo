...
export default function SignupScreen({ navigation }: { navigation: NativeStackNavigationProp<any> }) {
    ...
    const handleSignup = async () => {
        ...
        try {
            ...
            if (response.ok && data && typeof data === 'object' && data.success && data.user) {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Text style={styles.title}>Forge New Contract</Text>
                    <Text style={styles.subtitle}>Bind your hunter soul to AniGO</Text>

                    <View style={styles.inputGroup}>
                        <Text style={styles.inputLabel}>Cursed ID</Text>
                        <TextInput
                            style={styles.input}
                            placeholder="Choose a hunter ID"
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <View style={styles.inputRow}>
                            <TextInput
                                ...
                                placeholder="Create a seal phrase"
                                placeholderTextColor="#6B7280"
                                value={password}
                    ...
                    <View style={styles.inputGroup}>
                        <Text style={styles.inputLabel}>Confirm Seal</Text>
                        <View style={styles.inputRow}>
                            <TextInput
                                style={[styles.input, styles.inputWithIcon]}
                                placeholder="Repeat your seal phrase"
                                placeholderTextColor="#6B7280"
                            ...
                            <TouchableOpacity
                                ...
                                activeOpacity={0.7}
                            >
                                <View style={[styles.eyeOuter, showConfirmPassword && styles.eyeOuterActive]}>
                                    <View style={[styles.eyeInner, showConfirmPassword && styles.eyeInnerActive]} />
                                    <View style={[styles.eyeSlash, showConfirmPassword && styles.eyeSlashActive]} />
                                </View>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    >
                        {isLoading ? (
                            ...
                            <Text style={styles.buttonText}>Forge Contract</Text>
                        )}
                    </TouchableOpacity>
